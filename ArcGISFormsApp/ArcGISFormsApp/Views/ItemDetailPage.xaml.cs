...
namespace ArcGISFormsApp.Views
{
    ...
    public partial class ItemDetailPage : ContentPage
    {
        ...
        public ItemDetailPage(Item poiItem)
        {
            ...
            #region Create graphics overlays
            ...
            //{
            //    //TODO: logic to perform a fresh place search when new location is far from the original one
            //    //      outside of a specified buffer, for example
        ...
        private async Task ShowPlaces()
        {
            ...
            // Zoom to the places
            await MyMapView.SetViewpointGeometryAsync(_placesGraphicsOverlay.Extent);
        }
        ...
        async void MyMapView_GeoViewTapped(System.Object sender, Esri.ArcGISRuntime.Xamarin.Forms.GeoViewInputEventArgs e)
        {
            ...
            if (clickedElement != null)
            {
                ...
                // Create a callout definition that shows the name and address for the place
                ...
                definition.Tag = clickedElement; // set the element as a tag
        ...
        // Function that uses Xamarin.Essentials to open a web page
        #region
